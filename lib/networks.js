 ...
 * @param {Number} data.version.xpubkey.bytes - The extended public key version bytes
 * @param {Number} data.version.xpubkey.text - The extended public key version text
 * @param {Number} data.version.xprivkey.bytes - The extended private key version bytes
 * @param {Number} data.version.xprivkey.text - The extended private key version text
